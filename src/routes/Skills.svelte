...
<section class="skills" id="skills-section">
    <div class="title">
        <h2>My Skills</h2>
        <p>I have knowledge of Python (especially pandas, numpy, sklearn, imblearn, mathplotlib libraries)</p>
        <p>C++, JavaScript, Solidity. Now I am studying Machine Learning.</p>
        <div class="CV">
            <a class="btn" href={CV} download="CV Dmitrii Kuzmin" style="text-decoration: none;">Download CV</a>
        </div>
    </div>
    <div class="content">
        <div class="images">
