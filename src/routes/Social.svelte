...
<section class="social-media" id="social-media-section">
    <div class="content">
        ...
        <ul class="social-media-links">
            <li class="github" id="gh-link"><a href="https://github.com/1kkiRen"><img src={github_logo} alt=""></a></li>
            <li class="telegram" id="tg-link"><a href="https://t.me/ikkiren"><img src={telegram_logo} alt=""></a></li>
            <li class="vk" id="vk-link"><a href="https://vk.com/1kkiren"><img src={vk_logo} alt=""></a></li>
        </ul>
    </div>
</section>
